...
# Generated on: Fri Jul 12 12:47:06 IST 2024 (Fri Jul 12 07:17:06 UTC 2024)
...
set logfile output_files/rtl2intermediate.lec.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/single_port_ram -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k RTL_source/single_port_ram.v RTL_source/ram_mod.v
elaborate_design -golden -root {single_port_ram} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/single_port_ram/fv_map.v.gz
...
#add_name_alias fv/single_port_ram/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.single_port_ram.rtl.fv_map.tcl -class noneq -tclmode -replace
...
report_test_vector -noneq > noneq.test_vector.single_port_ram.rtl.fv_map.rpt
