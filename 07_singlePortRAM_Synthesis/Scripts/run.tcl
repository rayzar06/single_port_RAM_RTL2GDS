...
set_db / .init_lib_search_path { /run/media/user1/c2s/cadence/install/SCLPDK/scl_pdk/stdlib/fs120/liberty/lib_flow_ss /run/media/user1/c2s/cadence/install/SCLPDK/scl_pdk/stdlib/fs120/liberty/lib_flow_ff}
...
puts "load RTL"
set FILE_LIST  {single_port_ram.v ram_mod.v}
read_hdl $FILE_LIST
...
## Constraints Setup
####################################################################
read_sdc ./Constraints/RAM_Constraints.sdc
...
###### SDF file Generation ############
write_sdf -version 2.1 -recrem split -setuphold merge_when_paired -edges check_edge > ${_OUTPUTS_PATH}/single_port_ram_synth.sdf
