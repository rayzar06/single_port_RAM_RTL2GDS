...
set_input_transition	-max	$MAX_PORT 	[get_ports	oepad]

set_input_transition	-min	$MIN_PORT 	[get_ports	cspad]
set_input_transition	-min	$MIN_PORT 	[get_ports	wepad]
set_input_transition	-min	$MIN_PORT 	[get_ports	oepad]
...
set_input_delay  -add_delay -clock wr_vir_clk_i -max 7.75 [get_ports oepad] 
set_input_delay  -add_delay -clock wr_vir_clk_i -min 2.25 [get_ports oepad] 
