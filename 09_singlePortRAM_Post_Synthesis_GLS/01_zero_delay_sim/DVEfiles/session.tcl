...
# DVE full session
# Saved on Tue Jul 9 13:46:05 2024
# Designs open: 1
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 225]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 225
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 224} {height 744} {dock_state left} {dock_on_new_line true} {child_hier_colhier 256} {child_hier_coltype 54} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 109} {height 744} {dock_state left} {dock_on_new_line true} {child_data_colvariable 102} {child_data_colvalue 24} {child_data_coltype 51} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1863} {height 157} {dock_state bottom} {dock_on_new_line true}}
...
gui_view_scroll -id ${Hier.1} -vertical -set 2130
...
gui_open_source -id ${Source.1}  -replace -active ram_tb_with_pad /run/media/user1/c2s/sriram/singlePortRAM/09_singlePortRAM_Post_Synthesis_GLS/01_zero_delay_sim/ram_tb_with_pad.v
